...
public static class InsertionCompatibilityTestTexts
{
    ...
    [
        ...
        "Line break sample first line\r\nsecond line\r\nthird line.",
        "Tabbed columns:\tleft\tmiddle\tright",
        ...
        "PowerShell sample: Get-Process Shruti.App.WinUI | Select-Object Id,ProcessName",
        "SQL sample: select id, transcript_text from dictation_sessions where inserted = 1;",
        "Shell sample: git status -sb && dotnet test tests/Shruti.Tests/Shruti.Tests.csproj",
